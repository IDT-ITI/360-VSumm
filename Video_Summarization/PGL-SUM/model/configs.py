...
class Config(object):
    ...
    def set_dataset_dir(self, video_type='360VSumm'):
...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--n_segments', type=int, default=8, help='Number of segments to split the video')
    parser.add_argument('--pos_enc', type=str, default="absolute", help="Type of pos encoding [absolute|relative|None]")
    parser.add_argument('--heads', type=int, default=16, help="Number of global heads for the attention module")
