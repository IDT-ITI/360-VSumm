...
save_dir = Path('.../Summaries/360VSumm/exp1')
...
class Config(object):
    ...
    def set_dataset_dir(self, reg_factor=0.7, video_type='360VSumm'):
        ...
        :param str video_type: The Dataset being used, 360VSumm.
        """
...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--video_type', type=str, default='360VSumm', help='Dataset to be used')

    # Model
    parser.add_argument('--input_size', type=int, default=1024, help='Feature size expected in the input')
    parser.add_argument('--block_size', type=int, default=70, help="Size of blocks used inside the attention matrix")
    ...
    parser.add_argument('--batch_size', type=int, default=32, help='Size of each batch in training')
    ...
    parser.add_argument('--reg_factor', type=float, default=0.7, help='Length regularization factor')
